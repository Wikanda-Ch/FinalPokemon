...
public class StartGUI extends JFrame {
    ...
    public StartGUI(Trainner t) {
        ...
        JButton BtStore = new JButton("☞︎ 𝕎𝕚𝕝𝕕");
        JButton BtFight = new JButton("☞︎ 𝕊𝕖𝕥 ℕ𝕒𝕞𝕖");
        ...
        BtStore.setBounds(350, 180, 150, 50);
        BtFight.setBounds(350, 250, 150, 50);
        BtCatch.setBounds(350, 320, 150, 50);
        BtBack.setBounds(350, 390, 150, 50);

        Background.add(BtHome);
        Background.add(BtStore);
        Background.add(BtFight);
        ...
        BtStore.addActionListener((ActionEvent e) -> {
            setVisible(false);
            new WildGUI(t);

        });

        BtFight.addActionListener((ActionEvent e) -> {
            setVisible(false);
            new SetNameGUI(t);
